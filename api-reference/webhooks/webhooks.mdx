    ...
    "extractionOutput": {
      ...
      "field_4": {
        ...
        "schema": [
          {
            "id": "example_id_1",
            "fieldName": "sub_field_1",
            "type": "string",
            "description": "example description"
          },
          {
            "id": "example_id_2",
            "fieldName": "sub_field_2",
            "type": "number",
            "description": "example description"
          }
        ],
        ...
        "schema": [
          {
            ...
            "fieldName": "sub_field_1",
            "type": "string",
            "description": "The description for subfield_1"
          },
          {
            "id": "subfield_2",
            "fieldName": "sub_field_2",
            "type": "number",
            "description": "The description for subfield_2"
          }
        ],
        "arrayJSONSchema": "{\"type\":\"object\",\"properties\":{\"sub_field_1\":{\"type\":\"string\"},\"sub_field_2\":{\"type\":\"number\"}}}"
      }
...
export interface ExtractionFieldResult {
  ...
  type:
    ...
    | "object"
    | "null";
  schema?: ExtractorFieldInput[]; // Only set when type=array or type=object
  arrayJSONSchema?: string; // DEPRECATED: Only set when type=array
}
