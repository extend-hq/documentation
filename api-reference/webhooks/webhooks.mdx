...
**Note**: The extraction output fields shown in the payload above will conform to the following schema, and the field keys are defined when configuring the extractor 
...
export interface FieldResult {
  ...
  type: 
    ...
    | "array"
    | "null";
  arrayJSONSchema?: string
}
export interface FieldResultObject {
