...
```json Example Extract Output
{
  ...
  "edited": true,
  "type": "EXTRACT",
  "config": { // see ExtractConfig type below
    "fieldsToExtract": [
      {
        "id": "field1",
        "type": "boolean",
  ...
  "initialOutput": { // see ExtractOutput type below
    "is_invoice": {
      "id": "field1",
      "type": "boolean",
      "value": true,
  ...
  "reviewedOutput": { // see ExtractOutput type below
    "is_invoice": {
      "id": "field1",
      "type": "boolean",
      "value": false,
  ...
  "output": { // see ExtractOutput type below
    "is_invoice": {
      "id": "field1",
      "type": "boolean",
      "value": false,
...
```json Example Classify Output
{
  ...
  "edited": true,
  "type": "EXTRACT",
  "config": { // see ClassifyConfig type below
    "classifications": [
      {
        "id": "classification1",
        "type": "other",
  ...
  "initialOutput": { // see ClassifyOutput type below
    "id": "classification2",
    "type": "invoice",
    "confidence": 0.95,
    "observation": "The document contains information about invoice number, order number, invoice date, due date, total due, and payment details. It matches the description of an invoice."
  },
  "output": { // see ClassifyOutput type below
    "id": "classification2",
    "type": "invoice",
    "confidence": 0.95,
    "observation": "The document contains information about invoice number, order number, invoice date, due date, total due, and payment details. It matches the description of an invoice."
...
```json Example Instruct QA Output
{
  ...
  "edited": true,
  "type": "INSTRUCT_QA",
  "config": { // see InstructQAConfig type below
    "id": "instructqa1",
    "query": "buyer",
  ...
  "initialOutput": { // see InstructQAOutput type below
    "answer": "yes",
    "confidence": 1,
    "notes": [
  ...
  "output": { // see InstructQAOutput type below
    "answer": "yes",
    "confidence": 1,
    "notes": [
      "The invoice contains information about the sender (DEMO - Sliced Invoices) and the recipient (Test Business).",
