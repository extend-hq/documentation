...
<ParamField body="raw_texts" type="string[]">
  ...
  The raw data will be converted to .txt files and run through the workflow. 
  If the data follows a specific format, it is recommended to use the files parameter instead.
</ParamField>
