...
![](/images/studio/legacy_extractor.png)

Once in the step configuration view, you will see the large warning banner like the one in the image above.
You can then click on the "Export" option. This will create and download a JSON file to your computer. We will use this JSON file in the next step.
...
Once saved/run, go ahead and click "Publish" to create the first version of the processor:
...
After selecting the processor and version, click "Update version" to save.
