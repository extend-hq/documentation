...
All changes to a processor are saved on its draft version, which can be published as a new version at any time. You would want to publish when there is a chnge you want to make available to workflows that are using the processor.
Publishing a new version will not affect the existing workflows that are using the processor, as they will continue to use the version they were deployed with. This allows you to safely make changes and publish/pin versions as much you'd like.
...
to the draft before publishing a new version. Once you publish, all the draft changes will be rolled into the new version and the draft will go back
